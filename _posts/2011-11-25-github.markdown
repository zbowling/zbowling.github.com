...
As we continue to innovate new features on top of those changes to support our app, our fork is growing divergant. While we do [try](https://github.com/AFNetworking/AFNetworking/pull/125) to [send](https://github.com/AFNetworking/AFNetworking/pull/126) as many changes as we can upstream that we know may not conflict, we are the road to having a hard fork. 
